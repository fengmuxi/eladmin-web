  ...
  <div class="fillcontain">
    <div class="table_container">
      <el-table v-loading="loading" :data="appData" highlight-current-row style="width: 100%" border>
        ...
        <el-table-column property="versionName" label="版本名" width="100" />
        <el-table-column property="versionCode" label="版本号" width="100" sortable />
        ...
        <el-table-column property="modifyContent" label="更新内容" width="320" />
      ...
      <el-dialog title="修改版本信息" :visible.sync="dialogFormVisible">
        <el-form ref="appForm" :model="selectApp" :rules="apprules" label-width="100px">
          <el-form-item label="唯一号" prop="appKey">
            <el-input v-model="selectApp.appKey" placeholder="请输入应用的唯一号" />
          </el-form-item>
          <el-form-item label="版本名" prop="versionName">
            <el-input v-model="selectApp.versionName" placeholder="请输入应用版本名，例如：1.0.24" />
          </el-form-item>
          <el-form-item label="版本号" prop="versionCode">
            <el-input
              v-model="selectApp.versionCode"
              oninput="value=value.replace(/[^\d]/g,'')"
              placeholder="请输入应用版本号，例如：24"
            />
          </el-form-item>
          <el-form-item label="是否强制更新" prop="updateStatus">
            <el-switch v-model="selectApp.updateStatus" :inactive-value="1" :active-value="2" />
          </el-form-item>
          <el-form-item label="发布日期" prop="uploadTime">
            <el-date-picker
              v-model="selectApp.uploadTime"
              align="right"
              type="date"
              placeholder="选择日期"
          ...
          <el-form-item label="更新内容" prop="modifyContent">
            <el-input v-model="selectApp.modifyContent" type="textarea" placeholder="请输入更新日志..." />
          </el-form-item>
        </el-form>
